...
3. **Technical** docs spell out *how* a feature is built (created when implementation starts).
4. **Decisions** capture the *why* behind non-obvious choices (created at the moment of deciding).
